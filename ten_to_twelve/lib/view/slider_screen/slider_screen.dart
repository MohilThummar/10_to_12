...
//              ],
                ...
                rangeSlider: true,
                rtl: true,
                handlerAnimation: const FlutterSliderHandlerAnimation(curve: Curves.elasticOut, reverseCurve: null, duration: Duration(milliseconds: 700), scale: 1.4),
...
//rtl: true,
                  ...
                  tooltip: FlutterSliderTooltip(
                    textStyle: const TextStyle(fontSize: 17, color: Colors.lightBlue),
                  ),
            ...
            Container(
              ...
              child: FlutterSlider(
                ...
                hatchMark: FlutterSliderHatchMark(
                  ...
                  density: 0.5,
                  labels: [
                    FlutterSliderHatchMarkLabel(percent: 0, label: const Text('Start')),
                    FlutterSliderHatchMarkLabel(percent: 10, label: const Text('10,000')),
                    FlutterSliderHatchMarkLabel(percent: 50, label: const Text('50 %')),
                    FlutterSliderHatchMarkLabel(percent: 80, label: const Text('80,000')),
                    FlutterSliderHatchMarkLabel(percent: 100, label: const Text('Finish')),
                  ],
                ),
                jump: true,
                trackBar: const FlutterSliderTrackBar(),
